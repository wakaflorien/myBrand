...
const Hero = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row mx-auto items-center lg:justify-between gap-20 py-4 lg:py-12 px-4 lg:px-44 lg:py-4">
            <div>
                <Img 
            ...
            <div className="flex flex-col">
                ...
                <Typography className="text-center text-xl">
                    I’m a software/web developer who is passionate about creating interactive web, android applications and helping users interact with different technologies at the highest level.
                </Typography>
            </div>
        </div>
    )
