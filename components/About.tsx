      ...
      >
        <div className="flex flex-col lg:w-1/3 text-center items-center">
          <Icon
            ...
            className="my-2"
          />
          <Typography className="text-lg font-bold my-2">Back-end</Typography>
          <Typography className="text-lg text-primary font-bold">
            Languages
          </Typography>
          <Typography className="text-md my-1">NodeJs, Django, PHP</Typography>
          <Typography className="text-lg text-primary font-bold my-2">
            Databases
          </Typography>
          <Typography>MongoDB, MySQL, PostgresSQL</Typography>
          <Typography className="text-lg text-primary font-bold my-2">
            Servers
          </Typography>
        ...
        <div className="flex flex-col lg:w-1/3 text-center items-center border-t-2 lg:border-t-0 border-b-2 lg:border-b-0 lg:border-l-2 lg:border-r-2">
          ...
          <Typography className="text-md my-1">React, Next, Redux</Typography>
          <Typography className="text-lg text-primary font-bold">
            Styling
          </Typography>
          <Typography className="text-md my-1">
          ...
          <Typography className="text-md my-1">Github</Typography>
          <Typography className="text-md my-1">Terminal</Typography>
          <Typography className="text-md my-1">Bootstrap</Typography>
        </div>
        <div className="flex flex-col lg:w-1/3 text-center items-center">
          <Icon
            ...
            className="my-2"
          />
          <Typography className="text-lg font-bold my-2">Design</Typography>
          <Typography className="text-lg text-primary font-bold">
            What i design
          </Typography>
          <Typography className="text-md my-1">
          ...
          <Typography className="text-md my-1">Figma</Typography>
        </div>
      </section>
    </>
  );
